(() => {
  // ----- Configuration -----
  const ANS_WORDS = [
    "water","predation","adhesion","lipids","proteins","gene",
    "nucleus","membrane","mitochondria","enzyme","ribosome",
    "glucose","cellulose","adapt","organelle","organ","heart","evolution",
    "darwin", "genus", "species", "prey", "predator", "ecosystem", "producers",
    "chromosomes","alleles","gamete","mitosis","meiosis","herbivore","carnivore",
    "omnivore","selection","flora","fauna","domain","kingdom","phylum","class",
    "order","family","translation","transcription","inheritance","prophase",
    "metaphase","anaphase","telophase","interphase","chromatid","vacuole","cells",
    "organism","nutrition","plankton","unicellular","multicellular","mutation",
    "epidermis","symbiosis","parasite","fungus","bacteria","virus","metabolism",
    "mammal","reptile","cetacean","vertebrate","invertebrate","digestion","life",
    "cycle","synthesis","microscope","eukaryote","prokaryote","phylogeny","speciation",
    "expression","cytoplasm","dna","rna","cohesion","replication","genetics",
    "heredity","dominance","recessive","denaturation", "electroforesis",
    "primate","canine","feline","cetacean","habitat","nature","trophic","consumer",
    "quadrupedal","bipedal","homologous","analogous","sapien","biogenesis",
    "carbon","endosymbiosis","biology","biological","genotype","phenotype",
    "cytokinesis","asexual","reproduction","osmosis","diffusion","osmolarity",
    "cholesterol","vein","artery","alveoli","lungs","trachea","stomach","brain",
    "cranium","flagellum","intestine","antibodies","glands","protease","nuclease",
